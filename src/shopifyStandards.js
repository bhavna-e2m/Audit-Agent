...
export const CRO_CHECKPOINTS = {
  ...
  footer: [
    ...
    { id: "f.back_to_top",       group: "Footer",       text: "Footer has a 'Back to top' link." },
  ...
  home: [
    ...
    { id: "h.top_categories",    group: "Home / Content", text: "Most important product categories are shown first with descriptive photos near the top." },
    ...
    { id: "h.featured_products", group: "Home / Content", text: "Short list of important products with links is on the home page." },
    ...
    { id: "h.founder_story",     group: "Home / Content", text: "Founder story / mission / vision is shown." },
    ...
    { id: "h.press_logos",       group: "Home / Social Proof", text: "Press / blog / celebrity logos with brand exposure are highlighted (e.g. 'Used by executives at Fortune 500')." },
  ...
  collection: [
    ...
    { id: "c.notify_when_back",  group: "Collection / Cards", text: "Email-when-available capture for out-of-stock products." },
  ...
  product: [
    ...
    { id: "p.notify_in_stock",   group: "Product / General", text: "Email-when-back-in-stock capture for unavailable variants." },
    ...
    { id: "p.free_ship_callout", group: "Product / CTA", text: "Free shipping (if offered) is highlighted near the main CTA." },
    ...
    { id: "p.returns_info",      group: "Product / CTA", text: "Returns, refunds, and money-back guarantee info is clearly shown." },
    ...
    { id: "p.quantity_discount", group: "Product / Boosters", text: "Quantity discounts shown near CTA (1x, 2x, 3x with 'Top choice', 'Best value' badges)." },
    { id: "p.cross_upsell",      group: "Product / Boosters", text: "Relevant cross-sell / up-sell products offered.", linkedFeature: "relatedProducts" },
    { id: "p.bundles",           group: "Product / Boosters", text: "Bundle products offered with prominent discounts." },
    { id: "p.urgency",           group: "Product / Boosters", text: "Urgency triggers near CTA ('Today only', 'Ship today if ordered in 12 min')." },
    ...
    { id: "p.faqs",              group: "Product / Description", text: "Product page contains customer FAQs (product-specific + store-wide)." },
